...
Future<SendPaymentResponse> sendPayment({required String bolt11}) async {
  ...
  PrepareSendResponse prepareSendResponse = await breezLiquidSDK.instance!.prepareSendPayment(
  ...
  SendPaymentResponse sendPaymentResponse = await breezLiquidSDK.instance!.sendPayment(
